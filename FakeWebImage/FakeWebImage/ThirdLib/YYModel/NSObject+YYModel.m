...
- (instancetype)initWithClass:(Class)cls {
    ...
    while (curClassInfo && curClassInfo.superCls != nil) { // recursive parse super class, but
    ...
    [allPropertyMetas
        enumerateKeysAndObjectsUsingBlock:^(NSString *name, _YYModelPropertyMeta *propertyMeta, BOOL *stop) {
...
+ (instancetype)metaWithClass:(Class)cls {
    ...
    dispatch_once(&onceToken, ^{
        cache = CFDictionaryCreateMutable(
            CFAllocatorGetDefault(), 0, &kCFTypeDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks);
                ...
                case YYEncodingTypeNSMutableString: {
                    if ([value isKindOfClass:[NSString class]]) {
                        ...
                        ((void (*)(id, SEL, id))(void *)objc_msgSend)(
                            (id)model,
                            meta->_setter,
                            (meta->_nsType == YYEncodingTypeNSString) ? ((NSNumber *)value).stringValue
                        ...
                        ((void (*)(id, SEL, id))(void *)objc_msgSend)(
                            (id)model,
                            meta->_setter,
                            (meta->_nsType == YYEncodingTypeNSString) ? ((NSURL *)value).absoluteString
                    ...
                    if ([value isKindOfClass:[NSDictionary class]]) {
                        if (meta->_genericCls) {
                            ...
                            [((NSDictionary *)value) enumerateKeysAndObjectsUsingBlock:^(
                                                         NSString *oneKey, id oneValue, BOOL *stop) {
                            ...
                            if (meta->_nsType == YYEncodingTypeNSDictionary) {
                                ...
                                ((void (*)(id, SEL, id))(void *)objc_msgSend)(
                                    (id)model, meta->_setter, ((NSDictionary *)value).mutableCopy);
                            }
                        }
                    }
                } break;
...
static id ModelToJSONObjectRecursive(NSObject *model) {
    ...
    [modelMeta->_mapper enumerateKeysAndObjectsUsingBlock:^(
                            NSString *propertyMappedKey, _YYModelPropertyMeta *propertyMeta, BOOL *stop) {
